...
<ul class="b">
<li>Age (Edad)</li>
<li>Family History (AHF)</li>
<li>Smoking (TBQ)</li>
<li>Obesity (OBES)</li>
<li>Lipids Alteration (DLP)</li>
<li>Arterial Hypertension (HTA)</li>
</ul>
...
<h5>This box plot is created from the logistic regression. With the information gathered in the graphic we
...
<h2 style="margin-top:50px">Confusion table</h2>
