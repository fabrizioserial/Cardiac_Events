...
<div class="alert alert-dismissible alert-warning"  style="padding-top: 10px; padding-right: 15px; padding-bottom: 10px; padding-left: 15px; margin-top:40px">
...
<h5>The gender of patients in cardiac events is considered an important factor. According to an investigation led by the Norwegian University of Science and Technology, <a href=" https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2548254"> link </a> men have roughly twice the risk of cardiac events compared to women. As we can see on the charts, while gender distribution on the dataset is roughly even, 80% of patients which have had cardiac events are men.</h5>
...
<h5>Smoking cigarettes is a major risk factor for heart disease according to an article by the National Heart, Lung and Blood Institute (U.S). <a href="https://www.nhlbi.nih.gov/health-topics/smoking-and-your-heart">(link)</a> Smoking increases the probability of plaque buildup inside coronary arteries, which may lead to clogs, blood clots, heart disease, heart failure or a heart attack.</h5>
