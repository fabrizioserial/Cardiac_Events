---
title: "Study of factors that influence the ocurrence of cardiac events"
output:
  html_document:
    css: bootstrap.css
    theme: yeti
...
<h3 style="margin-top:20px; margin-bottom:10px">Cardiac Event by gender</h3>
...
<h3 style="margin-top:10px">Diabetic with cardiac events</h3> 
<div style="margin-top: 10px; margin-bottom:10px" >
...
<h3 style="margin-top:10px">Smoking distribution</h3> 
<div style="margin-top: 10px; margin-bottom:10px" >
...
<h3 style="margin-top:10px">Smokers with cardiac event</h3> 
<div style="margin-top: 10px; margin-bottom:10px" >
...
<h3 style="margin-top:10px">Family history distribution</h3> 
<div style="margin-top: 10px; margin-bottom:10px" >
...
<h3 style="margin-top:20px; margin-bottom:15px">Family history with event cardiac</h3>
...
legend(1.2,0.9,c("More than 20 min"," 1 to 20 min","Less than 1 min"),fill = c("#2A9FD6","#F4A236","#DA4531"),cex = 0.8)
...
<div class="alert alert-dismissible alert-primary" style="padding-left: 15px; margin-bottom:10px; margin-top:60px">
<p style="text-align:center; font-size: 40px">TEAM</p>
</div>
<img src="team_CardiacEvent.png" alt="Team">
</div>
